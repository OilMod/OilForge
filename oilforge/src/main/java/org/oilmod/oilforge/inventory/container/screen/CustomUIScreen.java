...
@OnlyIn(Dist.CLIENT)
public class CustomUIScreen<T extends OilChestLikeContainer>extends ContainerScreen<T> {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        for (int k = 0; k < rows; k++) {
            new DrawString(String.valueOf(k), 13.0F + i, 6.0F + j + (rows -k-1) * GuiSlotSize + GuiOffTop, 0x00FF00);
        }
