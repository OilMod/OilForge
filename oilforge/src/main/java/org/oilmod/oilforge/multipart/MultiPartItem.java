...
public class MultiPartItem extends Item {
    ...
    private static final String DEBUG_TOOL_PART_SELECTOR = "debug_tool_part_selector";

    public MultiPartItem(Item.Properties builder) {
        super(builder);
    }
    ...
    private void handleClick(PlayerEntity player, BlockState state, IWorld worldIn, BlockPos pos, boolean rightClick, ItemStack stack) {
        if (player.canUseCommandBlock()) {
            ...
            if (collection.isEmpty()) {
                ...
                if (Strings.isEmpty(s1) || s1.equals(DEBUG_TOOL_PART_SELECTOR)) {
