...
import org.oilmod.oilforge.multipart.TestMultiBlockTileEntity;
import org.oilmod.oilforge.multipart.TestMultiBlock;

public class TestMultiBlockRender extends TileEntityRenderer<TestMultiBlockTileEntity> {
    ...
    public TestMultiBlockRender(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn);
    }

    @Override
    public void render(TestMultiBlockTileEntity tileEntityIn, float partialTicks, MatrixStack ms, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
